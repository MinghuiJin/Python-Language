...
class Fraction:
    ...
    def __init__(self, numerator, denominator):
        ...
        if self.den == 0:
            raise ValueError("Error! The denominator of a fraction cannot be zero!")
...
def main():
    ...
    # num1 = get_number("Fraction1 numerator:")
    # den1 = get_number("Fraction1 denominator:")
    ...
    # num2 = get_number("\nFraction2 numerator:")
    # den2 = get_number("Fraction2 denominator:")
    # f2 = Fraction(num2, den2)
    f2 = get_fraction()



    # Note: Integrated as a def compute():
    result = None
